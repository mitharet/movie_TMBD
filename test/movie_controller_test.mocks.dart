...
// in movie/test/movie_controller_test.dart.
...
import 'package:movie/core/services/movie_services.dart' as _i4;
import 'package:movie/feature/movie_list/models/movie_response.dart' as _i3;
...
class MockMovieService extends _i1.Mock implements _i4.MovieService {
  ...
  @override
  _i5.Future<_i3.MovieResponse> fetchNowPlaying(int? page) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchNowPlaying,
          [page],
        ),
        returnValue: _i5.Future<_i3.MovieResponse>.value(_FakeMovieResponse_1(
          this,
          Invocation.method(
            #fetchNowPlaying,
            [page],
