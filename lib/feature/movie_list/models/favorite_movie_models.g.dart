...
part of 'favorite_movie_models.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class FavoriteMovieModelsAdapter extends TypeAdapter<FavoriteMovieModels> {
  @override
  final int typeId = 1;

  @override
  FavoriteMovieModels read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, FavoriteMovieModels obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is FavoriteMovieModelsAdapter &&
